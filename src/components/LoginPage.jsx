  ...
  return (
    <div className="min-h-[calc(100vh-64px)] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div
          className="absolute bottom-20 right-10 w-72 h-72 bg-indigo-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-purple-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse"
          ...
          >
            ...
            <div className="text-center mt-6">
              <p className="text-slate-600">
                ...
                <Link to="/register">
                  <span className="text-blue-600 hover:text-blue-700 font-semibold transition-colors duration-200">
                    Register
                  </span>
                </Link>
              </p>
